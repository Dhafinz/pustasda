...
export default async function AdminLeaderboardPage() {
  ...
  return (
    <DashboardLayout user={session.user} pageTitle="Leaderboard Siswa">
      <div className="animate-fade-in">
        {/* Leaderboard Title */}
        <div className="page-header">
          <h1>
            <i className="fa-solid fa-ranking-star text-yellow"></i> Leaderboard Prestasi Siswa
          </h1>
          <p>Tinjauan peringkat prestasi siswa berdasarkan akumulasi poin juara dan submit lomba sekolah.</p>
        </div>
        ...
        <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
          <div style={{ padding: '18px 24px', borderBottom: '1px solid var(--gray-light)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h3 style={{ fontSize: '0.92rem', fontWeight: 800 }}>Peringkat Prestasi</h3>
            <span style={{ fontSize: '0.72rem', color: 'var(--gray)' }}>{sorted.length} siswa aktif</span>
          </div>
